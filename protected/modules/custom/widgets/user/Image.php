...
namespace humhub\modules\custom\widgets\user;
...
class Image extends Widget
{
     ...
     */
    public $linkOptions = ['target'=>'_blank','title'=>''];
    ...
    public function run()
    {
        ...
        $this->linkOptions['title'] = $this->user->profile->firstname.' '.$this->user->profile->lastname;
        if ($this->link) {
