...
<div id="wallStream" data-stream="<?= $streamUrl ?>" <?= $contentIdData ?>
    ...
    <div class="s2_stream">
        ...
        <div class="back_button_holder" style="display:none">
            <a href="<?= Url::to(['/s/'.(isset($contentContainer->url)?$contentContainer->url:"")]) ?>" class="singleBackLink2 btn btn-primary"><?= Yii::t('ContentModule.widgets_views_stream', 'Back to stream'); ?></a><br><br>
        </div>
